...
//     }, []);
    ...
    //         };
    //         const {data} =  await axios.get(`http://localhost:7000/api/booking/detail/${params.id}` , { headers });
    //         console.log(data);
    //         setOutput(data);
    //     }
    //     getDt();
    ...
    const handleAccept = async (id, status) => {
        ...
        await axios.patch(`http://localhost:7000/api/booking/update/${id}/` , { status }, { headers });
